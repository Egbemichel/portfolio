...
function SidebarProvider({
    ...
    return (
        <SidebarContext.Provider value={contextValue}>
            <TooltipUI.TooltipProvider delayDuration={0}>
                <div
...
function SidebarMenuButton({
    ...
    asChild?: boolean;
    isActive?: boolean;
    tooltip?: string | React.ComponentProps<typeof TooltipUI.TooltipContent>;
    ...
    return (
        <TooltipUI.Tooltip>
            <TooltipUI.TooltipTrigger asChild>{button}</TooltipUI.TooltipTrigger>
